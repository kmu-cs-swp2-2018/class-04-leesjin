...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        resetlist = ['Error!','3.141592','3E+8','340','1.5E+8']
        ...
        if key == '=':
            ...
            constantdic = {0:'3.141592', 1:'3E+8', 2:'340', 3:'1.5E+8'}
            for i in range(0,4):
                if key == constantList[i]:
                    self.display.setText(self.display.text() + constantdic[i])

        elif key in functionList:
            n = self.display.text()
            fuctionsdic = {0: calcFunctions.factorial(n), 1: calcFunctions.decToBin(n), 2:calcFunctions.binToDec(n), 3:calcFunctions.decToRoman(n)}
            for i in range(0,4):
        ...
        '''
            ...
            self.display.setText(self.display.text() + '3.141592') #딕셔너리 로 전환
